        ...
        http
                ...
                .csrf(csrf -> csrf
                        ...
                        .ignoringRequestMatchers("/api/scenario51/**", "/api/scenario66/**", "/api/scenario67/**",
                                ...
                                "/api/scenario76/**", "/api/scenario77/**", "/api/scenario78/**", "/api/scenario79/**", "/api/scenario80/**", "/api/scenario81/**", "/api/scenario82/**", "/api/scenario83/**", "/api/scenario84/**", "/api/scenario85/**", "/api/scenario86/**", "/api/scenario87/**", "/api/scenario88/**", "/api/scenario2/**",
                                "/actuator/**",
                                "/v3/api-docs/**",
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/scenario83/**", "/api/scenario84/**", "/api/scenario85/**", "/api/scenario86/**", "/api/scenario87/**", "/api/scenario88/**", "/api/scenario2/**").permitAll() // Added Scenarios 83/84/85/86/87/88 and 2
