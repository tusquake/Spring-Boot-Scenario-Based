...
public class JwtUtils {
    ...
    // In a real app, this would be in application.properties
    private static final String SECRET = "mysecretkeythatisverylongandverysecureforthisdemonstrationpurpose";
